      ...
      >
        ...
        <div className="p-4 sm:p-7 border-b border-slate-100 bg-slate-50/60 flex items-start justify-between gap-3 sm:gap-4 sticky top-0 z-10 backdrop-blur-md">
          <div className="flex items-start space-x-3 sm:space-x-4 min-w-0">
            <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl border border-slate-200 bg-white p-1.5 sm:p-2 flex items-center justify-center shrink-0 shadow-xs">
              <img
                src={job.companyLogo}
                alt={job.company}
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs sm:text-sm font-semibold text-slate-600 mt-0.5 flex items-center space-x-2">
                <span className="truncate">{job.company}</span>
                <span>•</span>
                <span className="text-slate-400 text-xs shrink-0">{job.postedTime}</span>
              </p>
            </div>
          </div>
        ...
        <div className="p-3.5 sm:p-6 border-t border-slate-100 bg-white flex items-center justify-between gap-2 sm:gap-3">
          <div className="flex items-center space-x-1.5 sm:space-x-2 shrink-0">
            <button
              id="modal-share-btn"
              onClick={(e) => onShare && onShare(job, e)}
              className="px-2.5 sm:px-3.5 py-2 sm:py-2.5 rounded-xl border border-slate-200 text-slate-700 hover:bg-slate-50 flex items-center space-x-1 sm:space-x-2 text-xs sm:text-sm font-semibold transition-all cursor-pointer"
              title="Chia sẻ tin tuyển dụng"
            >
            ...
            <button
              ...
              className={`px-2.5 sm:px-4 py-2 sm:py-2.5 rounded-xl border flex items-center space-x-1 sm:space-x-2 text-xs sm:text-sm font-semibold transition-all cursor-pointer ${
                job.isSaved
          ...
          <div className="flex items-center flex-1 sm:flex-initial justify-end">
            <button
              ...
              className="w-full sm:w-auto px-5 sm:px-6 py-2 sm:py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-xs sm:text-sm rounded-xl shadow-md shadow-indigo-200 transition-all cursor-pointer text-center whitespace-nowrap"
            >
              Ứng tuyển ngay
            </button>
          </div>
